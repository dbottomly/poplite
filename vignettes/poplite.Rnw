...
side indicates the primary key of 
...
#need to fix me, maybe a shortcut to the primary key of reference
try(relationship(vcf.sc, from="alleles", to="sample_alleles") <- .~.reference+alt)
